 ...
 * @author gabriel
 */
public class TotalProfessorPrograma
{
    ...
    private float total_por_programa;
    
    public TotalProfessorPrograma()
    {
        this.nome_programa = "";
    ...
    public float getTotal_por_programa()
    {
        return total_por_programa;
    }
    ...
    {
        return this.artigos_revistas_A1 / this.total_por_programa;
    }
    
    public float mediaArtigosRevistasA2()
    {
        return this.artigos_revistas_A2 / this.total_por_programa;
    }
    
    public float mediaArtigosRevistasB1()
    {
        return this.artigos_revistas_B1 / this.total_por_programa;
    }
    
    public float mediaArtigosRevistasB2()
    {
        return this.artigos_revistas_B2 / this.total_por_programa;
    }
    
    public float mediaArtigosRevistasB3()
    {
        return this.artigos_revistas_B3 / this.total_por_programa;
    }
    
    public float mediaArtigosRevistasB4()
    {
        return this.artigos_revistas_B4 / this.total_por_programa;
    }
    
    public float mediaArtigosRevistasC()
    {
        return this.artigos_revistas_C / this.total_por_programa;
    }
    
    public float mediaArtigosRevistasNC()
    {
        return this.artigos_revistas_NC / this.total_por_programa;
    }
    ...
    {
        return this.artigos_eventos_A1 / this.total_por_programa;
    }
    
    public float mediaArtigosEventosA2()
    {
        return this.artigos_eventos_A2 / this.total_por_programa;
    }
    
    public float mediaArtigosEventosB1()
    {
        return this.artigos_eventos_B1 / this.total_por_programa;
    }
    
    public float mediaArtigosEventosB2()
    {
        return this.artigos_eventos_B2 / this.total_por_programa;
    }
    
    public float mediaArtigosEventosB3()
    {
        return this.artigos_eventos_B3 / this.total_por_programa;
    }
    
    public float mediaArtigosEventosB4()
    {
        return this.artigos_eventos_B4 / this.total_por_programa;
    }
    
    public float mediaArtigosEventosC()
    {
        return this.artigos_eventos_C / this.total_por_programa;
    }
    
    public float mediaArtigosEventosNC()
    {
        return this.artigos_eventos_NC / this.total_por_programa;
    }
    ...
    {
        return this.participacao_banca_doutorado / this.total_por_programa;
    }
    
    public float mediaParticipacaoBancaMestrado()
    {
        return this.participacao_banca_mestrado / this.total_por_programa;
    }
    
    public float mediaParticipacaoBancaGraduacao()
    {
        return this.participacao_banca_graduacao / this.total_por_programa;
    }
    ...
    {
        return this.orientacao_concluida_doutorado / this.total_por_programa;
    }
    
    public float mediaOrientacaoConcluidaMestrado()
    {
        return this.orientacao_concluida_mestrado / this.total_por_programa;
    }
    
    public float mediaOrientacaoConcluidaGraduacao()
    {
        return this.orientacao_concluida_graduacao / this.total_por_programa;
    }
    ...
    {
        return this.orientacao_andamento_doutorado / this.total_por_programa;
    }
    ...
    {
        return this.orientacao_andamento_graduacao / this.total_por_programa;
    }
    ...
    public String getProgramaTotalBonitinho()
    {
        return  "\nArtigos em Revistas: \t\t" + 
